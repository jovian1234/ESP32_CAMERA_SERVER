  ...
  void setupLedFlash() {
  #if defined(LED_GPIO_NUM)
      // Check if we are using ESP32 Arduino Core v3.0.0 or higher
      #if ESP_ARDUINO_VERSION >= ESP_ARDUINO_VERSION_VAL(3, 0, 0)
        ledcAttach(LED_GPIO_NUM, 5000, 8); // New API style for v3.x
  #else
    // Old API style for v2.x: channel 0, 5000 Hz, 8-bit resolution
    ledcSetup(0, 5000, 8); 
